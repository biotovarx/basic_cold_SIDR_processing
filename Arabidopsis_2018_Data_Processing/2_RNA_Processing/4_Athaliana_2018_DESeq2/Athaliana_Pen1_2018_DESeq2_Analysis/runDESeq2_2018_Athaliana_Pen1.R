...
DownCORGenes <- read_csv("Arabidopsis_Supporting_Data/Shi_et_al_2018_All_Downreg_COR_genes_identified_in_Col.csv")
...
pen1Outliers <- c("At_Pen1_UTC_1_E1_T14_counts.txt",
...
output_dir <- paste(getwd(), "/Athaliana_Pen1_2018_DESeq_", outLabel, "_", outDate, sep="")
...
logFile <- file.path(output_dir, paste("Analysis_Log_", outDate, ".txt", sep = ''))
  cat("At_Pen1_DE_Analysis",file=logFile,sep="\n")
