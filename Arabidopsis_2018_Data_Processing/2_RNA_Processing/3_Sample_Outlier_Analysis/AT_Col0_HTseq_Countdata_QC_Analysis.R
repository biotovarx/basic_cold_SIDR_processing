...
directory <- "Athaliana_Col0_2018_HTseq/"
...
ggplot(gatheredallFileCounts, aes(x = reorder(FileName, TotalCounted2), y = Reads, group = FileName)) + 
  ...
  labs(x="Sample", y="Reads", title="A. thaliana Col-0 2018 HTseq Read Breakdown")



plotOutFile <- file.path(getwd(), "Athaliana_Col0_2018_HTseq_Read_Breakdown.png")
